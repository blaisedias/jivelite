...
function registerApplet(self)
	...
	if Framework:getWmAvailable() == true then
		...
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_1200_1920"), "JogglerSkin", "skin1200x1920", "JogglerSkin_1200x1920")
		...
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_1920_1200"), "JogglerSkin", "skin1920x1200", "JogglerSkin_1920x1200")
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_1920_480"), "JogglerSkin", "skin1920x480", "JogglerSkin_1920x480")
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_WQVGA"), "JogglerSkin", "skin480x272", "JogglerSkin_WQVGA")
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_WQVGA_PORTRAIT"), "JogglerSkin", "skin480x272", "JogglerSkin_WQVGA_Portrait")
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_QVGA_SQUARE"), "JogglerSkin", "skin240x240", "JogglerSkin_QVGA_Square")
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_QVGA"), "JogglerSkin", "skin320x240", "JogglerSkin_QVGA")
		jiveMain:registerSkin(self:string("JOGGLER_SKIN_QVGA_PORTRAIT"), "JogglerSkin", "skin240x320", "JogglerSkin_QVGA_Portrait")
