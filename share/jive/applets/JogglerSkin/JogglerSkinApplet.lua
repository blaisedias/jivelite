...
--		imgpath .. CONTROLS_THEME_PATH .. "/Buttons/control_keyboard_button_press.png",
	...
	local activeNowPlayingScreenStyles = {}
...
--	})
	...
	for _,v  in pairs(self:param().nowPlayingScreenStyles) do
		jsData[v.style] = jogglerScaler.getNowPlayingStyleJsonTable(s[v.style])
	end
	jogglerScaler.writeCacheJsonFile(jsData, '/cache/JogglerNowplaying.json')
